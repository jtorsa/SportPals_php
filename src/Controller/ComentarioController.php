...
class ComentarioController extends AbstractController
{
    ...
    /**
     * @Route("/new", name="comentario_new_ajax", methods={"GET","POST"})
     */
    public function new(Request $request)
    {
        $param = $request->query->all();
        $this->comentarService->addComment($param);

        return $this->redirectToRoute('evento_show',['id'=>$param['event_id']]);
    }
